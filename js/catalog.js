...
function addSelectedItemToCart() {
  ...
  var quantityPickedInput = document.getElementById('quality');
  var itemPicked = document.getElementById('quantity');
